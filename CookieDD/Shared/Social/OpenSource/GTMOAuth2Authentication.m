...
static NSString *const kOAuth2ClientIDKey __unused         = @"client_id";
static NSString *const kOAuth2ClientSecretKey __unused      = @"client_secret";
static NSString *const kOAuth2RedirectURIKey __unused      = @"redirect_uri";
static NSString *const kOAuth2ResponseTypeKey __unused     = @"response_type";
...
static NSString *const kRefreshFetchArgsKey __unused = @"requestArgs";
