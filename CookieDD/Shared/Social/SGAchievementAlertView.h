...
typedef enum SGAchievementAlertScreenPosition {
    
    SGAchievementAlertScreenPositionTopCenter,
    SGAchievementAlertScreenPositionBottomCenter
    
} SGAchievementAlertScreenPosition;

@interface SGAchievementAlertView : UIView

@property (weak, nonatomic) IBOutlet UIView *messageBar;
@property (weak, nonatomic) IBOutlet SGStrokeLabel *messageLabel;
//@property (weak, nonatomic) IBOutlet SGStrokeLabel *messageLabel;
