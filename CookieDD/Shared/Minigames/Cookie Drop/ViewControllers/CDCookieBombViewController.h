...
@protocol CDCookieBombViewControllerDelegate;


@interface CDCookieBombViewController : UIViewController <CDCookieBombSceneDelegate>

@property (weak, nonatomic) id<CDCookieBombViewControllerDelegate> delegate;
@property (strong, nonatomic) CDLoadingScreenViewController *loadingScreen;

@end


@protocol CDCookieBombViewControllerDelegate <NSObject>
