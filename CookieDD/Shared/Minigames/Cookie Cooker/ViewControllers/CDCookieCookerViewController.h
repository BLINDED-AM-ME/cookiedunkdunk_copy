//
//  CDCookieCookerViewController.h
//  CookieDD
//
...
@protocol CDCookieCookerViewControllerDelegate;



@interface CDCookieCookerViewController : UIViewController <CDCookieCookerSceneDelegate>

@property (weak, nonatomic) id<CDCookieCookerViewControllerDelegate> delegate;
...
@protocol CDCookieCookerViewControllerDelegate <NSObject>
