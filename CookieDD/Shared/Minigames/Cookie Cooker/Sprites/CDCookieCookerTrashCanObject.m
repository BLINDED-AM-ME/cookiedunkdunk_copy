//
//  CDCookieCookerTrashCanObject.m
//  CookieDD
//
...
@interface CDCookieCookerTrashCanObject()
...
@implementation CDCookieCookerTrashCanObject
...
- (id)initWithScene:(SKScene *)scene
{
    ...
    if (IS_IPHONE_5 || IS_IPHONE_4)
    {
        ...
        self.isIphone = YES;
        self.bufferTwoCheck = 10;
    }
    else
    {
        atlas = [SKTextureAtlas atlasNamed:@"cookieCooker_accessories_ipad"];
        self.isIphone = NO;
        self.bufferTwoCheck = 70;
    }
    
    self.theTexture = [atlas textureNamed:@"cookieCooker_trashCan_full"];
    ...
    return [super initWithTexture:self.theTexture];
}

- (float)moveTheTrash:(float)position
{
